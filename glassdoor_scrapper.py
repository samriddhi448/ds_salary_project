# -*- coding: utf-8 -*-
"""
Created on Fri May 21 21:37:26 2021
...
def get_jobs(keyword, num_jobs, verbose,path,slp_time):
    ...
    driver = webdriver.Chrome(executable_path="C:/Users/samriddhi/Desktop/ds_salary_project/chromedriver", options=options)
    ...
    #url = "https://www.glassdoor.com/Job/jobs.htm?suggestCount=0&suggestChosen=false&clickSource=searchBtn&typedKeyword="+keyword+"&sc.keyword="+keyword+"&locT=&locId=&locKeyword=San%20Francisco,&cityId=-1&jobType="
    url = "https://www.glassdoor.com/Job/jobs.htm?suggestCount=0&suggestChosen=false&clickSource=searchBtn&typedKeyword=data+s&typedLocation=San+Francisco%2C+CA&locT=C&locId=1147401&jobType=&context=Jobs&sc.keyword=Data+Scientist&dropdown=0"
    driver.get(url)
    jobs = []
